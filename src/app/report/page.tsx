                      ...
                      <div className="treatment-engine-side">
                        {toBooleanFlag(item.showImage, true) && (
                          <div
                            ...
                            style={{
                              backgroundImage: `url(${formatUrl(item.image) || treatmentRecommendationImages[itemIndex % treatmentRecommendationImages.length] || scalpRepresentativeImage})`,
                            }}
                            aria-hidden="true"
                          />
                        )}
                  ...
                  >
                    <div className="personalised-phase-top">
                      ...
                      <div
                        ...
                        style={{
                          backgroundImage: `url(${formatUrl(phaseItem.image) || section9PhaseImages[phaseIndex % section9PhaseImages.length] || scalpRepresentativeImage})`,
                        }}
                        aria-hidden="true"
                      />
                    </div>
                    ...
                    {recommendationRows.map((row, idx) => (
                      <article className="side-product-card" key={idx}>
                        <div
                          ...
                          style={{ backgroundImage: `url(${formatUrl(row.image) || sharedThumbImage})` }}
                        />
